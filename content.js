(() => {
  const DEFAULT_WAIT_MS = 2000; // increased for stability
  ...
  async function expandAll() {
    ...
    try {
      ...
      while (safety-- > 0) {
        ...
        // 🔥 Click ALL expand buttons at once (fix)
  ...
  function createFloatingPanel(savedCount = DEFAULT_COUNT) {
    ...
    panel.innerHTML = `
      <button id="gh-expand-all-btn" type="button" style="padding:6px 10px; cursor:pointer;">Expand all Comments</button>
